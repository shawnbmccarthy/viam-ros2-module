...
Registry.register_subtype(ResourceRegistration(ROS2LoggerService, ROS2LoggerRPCService, lambda name, channel: ROS2LoggerClient(name, channel)))

Registry.register_resource_creator(ROS2LoggerService.SUBTYPE, MyROS2LoggerService.MODEL, ResourceCreatorRegistration(MyROS2LoggerService.new))